<form id="QMCV_options" method="POST">
	<input type="hidden" name="security" value="<?php echo wp_create_nonce( "QMCV_options" ) ?>" />
			...
			<tr>
				...
				<td>
					...
					<label for="capability-<?php echo $key ?>">
						<input type="checkbox" id="capability-<?php echo $key ?>" name="capability[<?php echo $key ?>]" <?php if ( in_array( $key, Check_Variables_Options::get_capability() ) ) echo 'checked="checked"'; ?> />
					...
					<label for="capability-<?php echo $key ?>">
						<input type="checkbox" id="capability-guest" name="capability[guest]" <?php if ( in_array( 'guest', Check_Variables_Options::get_capability() ) ) echo 'checked="checked"'; ?> />
						 Guest
					</label>
